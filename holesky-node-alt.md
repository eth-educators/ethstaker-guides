...
```console
$ cd ~
$ wget https://github.com/ChainSafe/lodestar/releases/download/v1.19.0/lodestar-v1.19.0-linux-amd64.tar.gz
$ tar xvf lodestar-v1.19.0-linux-amd64.tar.gz
$ rm lodestar-v1.19.0-linux-amd64.tar.gz
```
