...
You can change the min-bid value to reflect how much you want to use the MEV relays in relation to how much they are offering in terms of rewards. There is little value in giving all block production to MEV relays if they are not to offer any substantial rewards in exchange. The 0.05 ETH min-bid value is a good compromise. You can learn more on about this on [The Cost of Resilience](https://writings.flashbots.net/the-cost-of-resilience/).
