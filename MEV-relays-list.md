...
If you need help installing and configuring mev-boost on your machine, check out our [Guide on how to prepare a staking machine for the Merge](prepare-for-the-merge.md#choosing-and-configuring-an-mev-solution)