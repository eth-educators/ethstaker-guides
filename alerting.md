...
Knowning when there is a potential problem with your machine or your processes is a very good practice in IT. It can help you prevent major issues with your system. Alerting is the art of getting notified for when those issues are rising up. A common issue for which alerting is very useful and that many validators are likely to face is low remaining disk space because of the clients' databases growth and [the need to do some pruning](https://www.reddit.com/r/ethstaker/comments/n7mnx5/psa_if_youre_running_geth_prune/) to control that growth.
...
```console
$ sha256sum alertmanager-0.23.0.linux-amd64.tar.gz
```
